...
integer index based, so you have to specify rows and columns by their integer
index like you did in the previous exercise.
...
Hint
For the first instruction, use .loc['JAP'] or .iloc[2]. Don't forget to wrap your code in a print() statement.
For the second instruction, use .loc[['AUS', 'EG']] or .iloc[1,6]. Don't forget to wrap your code in a print() statement.
"""
