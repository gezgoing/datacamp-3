"""
The Python code that solves the previous exercise is included on the below.
...
labels of the cars DataFrame. You do this by setting the index attribute of cars, that you can access as cars.index.
...
Hint
To set the labels of the rows, use car.index = .... Of course, fill in the dots correctly with the predefined labels.
